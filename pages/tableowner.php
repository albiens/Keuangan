...
<div class="limiter">
		<div class="container-login100" style="background-image: url('../lib/Login_v3/images/73013596_p1.png');">
            ...
            <span class="login100-form-title p-b-34 p-t-27">
						Silahkan Pilih Tabel Yang Ingin Di Tampilkan
            </span>
            
    <div class="container-login100-form-btn">
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablepemasukanowner.php'" >Pemasukan</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablepengeluaranowner.php'" >Pengeluaran</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablesumown.php'" >Pendapatan</button>
	<button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/homeowner.php'" >back</button>
    </div>
            </div>
        </div>
</div>
