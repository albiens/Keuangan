...
<body>
  ...
  <td><img src='../bon_pengeluaran/".$data["foto"]."' width='100' height='100'></td><br><br>
  ";
?>
</body>

<button  type="button" onclick="window.location.href='../pages/tablepengeluaranowner.php'" >back</button>
