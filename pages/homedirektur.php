...
<div class="limiter">
    ...
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/pemasukan.php'" >
		Input Pemasukan
	</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/pengeluaran.php'" >Input Pengeluaran</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/table.php'" >Table</button>
