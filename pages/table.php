...
<div class="limiter">
    ...
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablepemasukan.php'" >Pemasukan</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablepengeluaran.php'" >Pengeluaran</button>
    <button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/tablesum.php'" >Pendapatan</button>
	<button class="login100-form-btn bton" type="button" onclick="window.location.href='../pages/homedirektur.php'" >back</button>
    </div>
            </div>
        </div>
</div>
