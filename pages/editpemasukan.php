...
<div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                <div class="card-heading"></div>
                    <div class="card-body">
                        <h2 class="title">Merubah Data Pemasukan</h2>
  <?php
  ...
  <div class="p-t-10">
                        ...
                        <button class="btn btn--pill btn--green" type="button" onclick="window.location.href='../pages/tablepemasukan.php'" >Back</button>
                    </div>
</body>
